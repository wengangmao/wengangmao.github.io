...
2. <span style = "font-weight: 400; font-size: 20px; color: blue">MOPSO implementation for hybrid RPM modes<span style = "background: yellow"> [by end of this week]<br /> </span></span>
#### More specific
